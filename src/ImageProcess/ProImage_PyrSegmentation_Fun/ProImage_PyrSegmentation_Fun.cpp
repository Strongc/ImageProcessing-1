// ProImage_PyrSegmentation_Fun.cpp : Defines the entry point for the console application.
//
...
int main( )
{
	...
	//载入原图
	g_srcImage = imread("mUnUJf.jpg");//工程目录下需要有一张名为1.jpg的测试图像，且其尺寸需被2的N次方整除，N为可以缩放的次数
